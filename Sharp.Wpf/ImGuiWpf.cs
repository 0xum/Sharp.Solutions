using Sharp.ImGui.Wpf.Controls;
using Sharp.ImGui.Wpf.Factories;
using Sharp.ImGui.Wpf.Layouts;
using Sharp.ImGui.Wpf.Styles;
using System;
...
namespace Sharp.ImGui.Wpf
{
    public class ImGuiWpf : IDisposable
    {
        ...
        public static void DisableToolTipDelay ( )
        {
